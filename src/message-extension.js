import { RileyActivityHandler, CardFactory } from 'botbuilder';
import faker from 'faker';

export default class MessageExtension extends RileyActivityHandler {
     ...
     */
    async handleRileyMessagingExtensionQuery(context, query) {
     ...
     */
    async handleRileyMessagingExtensionSelectItem(context, obj) {
